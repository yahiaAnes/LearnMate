...
export default function Responses() {
    ...
    const handleCancel = (requestId: number) => {
        alert("Do you want to cancel this request?");
        router.post(route('responses.cancel', requestId), {}, {
            preserveScroll: true,
            onSuccess: () => {
                        ...
                        {filteredRequests.length > 0 ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center space-x-4 pt-4">
                                                <Avatar className="w-8 h-8">
                                                    <AvatarImage src={request.user?.profile_image || undefined} />
                                                    <AvatarFallback className="bg-gray-700 text-gray-300">
                                                        {(request.user?.name || 'Unknown').charAt(0).toUpperCase()}
                                                    </AvatarFallback>
                                                </Avatar>
                                                <div>
                                                    <p className="text-sm text-gray-300">To: {request.user?.name || 'Unknown User'}</p>
                                                    <p className="text-xs text-gray-400">{request.user?.speciality || 'No speciality'}</p>
                                                </div>
                                            </div>
                                                ...
                                                <Dialog>
                                                    ...
                                                    <DialogContent className="bg-gray-800 border-gray-700 max-h-[80vh] overflow-y-auto">
                                                        <DialogHeader>
                                                            ...
                                                            <DialogDescription className="text-gray-400 whitespace-pre-wrap max-h-[200px] overflow-y-auto break-words">
                            ...
                            <div className="col-span-full text-center py-12">
                                <div className="text-gray-400 mb-4">
                                    ...
                                    <p className="text-gray-400">You don't have any session responses at the moment.</p>
                                </div>
                            </div>
                        )}
                    </div>
